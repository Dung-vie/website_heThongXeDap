                ...
                <div class="card-body">
                    <form action="{{ route('review.store', $rental->id) }}" method="POST">
                        ...
                        <h5 class="fw-bold text-success mb-3">
                            <i class="bi bi-bicycle"></i>Mã Xe: {{ $rental->bike->plate_number }}
                        </h5>
                            ...
                            <div class="d-flex gap-2">
                                @for ($i = 1; $i <= 5; $i++)
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="bike_rating"
                                            value="{{ $i }}" id="bike_rating_{{ $i }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="bike_comment" class="form-control" rows="4" maxlength="200" placeholder="Xe sạch sẽ, dễ đi..."></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-2">
                                @for ($i = 1; $i <= 5; $i++)
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="station_rating"
                                            value="{{ $i }}" id="station_rating_{{ $i }}"
                                            required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="station_comment" class="form-control" rows="4" maxlength="200"
