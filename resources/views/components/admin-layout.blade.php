...
<div class="d-flex" style="min-height:100vh">
    ...
    {{-- Sidebar --}}
    <div class="bg-black text-white p-3" style="width:220px; flex-shrink:0">
        <h4 class="text-warning mb-4">Dashboard</h4>
        <ul class="nav flex-column gap-1">
            <li><a href="/admin"    class="nav-link text-white {{ request()->is('admin')  ? 'bg-secondary rounded' : '' }}">
                <i class="bi bi-bicycle"></i> Admin</a></li>
